...
- =gptel/sessions/= - Session management (6 modules)
- =gptel/skills/= - Skills system (3 modules)
- =gptel/tools/= - Tool definitions (7 modules)
...
1. Registry - Global session registry and initialization
2. Metadata - Metadata persistence and tree operations
3. Tracing - Agent execution tracing
4. Hooks - Advice functions and auto-save
5. Browser - Session browsing and reconstruction
6. Branching - Branch creation and management
