...
(jf/load-module (expand-file-name "gptel/skills/skills-core.el" jf/emacs-dir))
(jf/load-module (expand-file-name "gptel/skills/skills-roam.el" jf/emacs-dir))
(jf/load-module (expand-file-name "gptel/skills/skills-transient.el" jf/emacs-dir))
...
(use-package gptel-agent
  ...
  (add-to-list 'gptel-agent-dirs
               (expand-file-name "gptel/agents/" jf/emacs-dir))

  ;; Load custom tools BEFORE agent update so agents can reference them
  (jf/load-module (expand-file-name "gptel/tools/filesystem-tools.el" jf/emacs-dir))
  (jf/load-module (expand-file-name "gptel/tools/projectile-tools.el" jf/emacs-dir))
  (jf/load-module (expand-file-name "gptel/tools/ggtags-tools.el" jf/emacs-dir))
  (jf/load-module (expand-file-name "gptel/tools/treesitter-tools.el" jf/emacs-dir))
  (jf/load-module (expand-file-name "gptel/tools/org-roam-tools.el" jf/emacs-dir))
  (jf/load-module (expand-file-name "gptel/tools/meta-tools.el" jf/emacs-dir))
  (jf/load-module (expand-file-name "gptel/tools/community-tools.el" jf/emacs-dir))
...
(jf/load-module (expand-file-name "gptel/sessions/registry.el" jf/emacs-dir))
(jf/load-module (expand-file-name "gptel/sessions/metadata.el" jf/emacs-dir))
(jf/load-module (expand-file-name "gptel/sessions/tracing.el" jf/emacs-dir))
(jf/load-module (expand-file-name "gptel/sessions/hooks.el" jf/emacs-dir))
(jf/load-module (expand-file-name "gptel/sessions/browser.el" jf/emacs-dir))
(jf/load-module (expand-file-name "gptel/sessions/branching.el" jf/emacs-dir))
