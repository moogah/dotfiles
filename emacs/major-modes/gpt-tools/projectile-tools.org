#+title: GPTEL Projectile Tools
#+author: Jeff Farr
#+property: header-args:emacs-lisp :tangle projectile-tools.el
#+auto_tangle: y

* Introduction
This file defines gptel tools for project-aware navigation using Projectile.
These tools enable LLMs to understand project scope, boundaries, and file structure.

* Basic Configuration
Setup lexical binding and require projectile package.
...
** list_known_projects
List all known projects tracked by projectile. This is the primary discovery tool.
...
** get_project_info
Get high-level overview of a specific project including root, name, type, and VCS.
...
* Project File/Directory Tools

** list_project_files
List all files in the project, respecting ignore rules from VCS and projectile config.
...
List all directories in project structure to understand layout.
...
** expand_project_path
Convert relative path to absolute within project context.
