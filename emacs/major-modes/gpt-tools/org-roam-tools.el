...
(gptel-make-tool
 ...
 :function (lambda (title &optional tags content refs)
...
The node is created as a file-level node (level 0) in your org-roam-directory. You can add tags, initial content, and reference URLs.
