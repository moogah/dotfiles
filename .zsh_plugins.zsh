...
fpath+=( "$HOME/Library/Caches/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-larkery-SLASH-zsh-histdb" )
source "$HOME/Library/Caches/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-larkery-SLASH-zsh-histdb/zsh-histdb.plugin.zsh"
